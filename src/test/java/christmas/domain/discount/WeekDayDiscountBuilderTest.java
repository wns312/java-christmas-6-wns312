...
class WeekDayDiscountBuilderTest {
    ...
    private WeekDayDiscountBuilder createWeekDayDiscountBuilder(VisitDate visitDate) {
        ...
        return new WeekDayDiscountBuilder(new Reservation(visitDate, orderMenus));
    }
    ...
    void checkDiscountableVisitDateTest(int date) {
        ...
        WeekDayDiscountBuilder weekDayDiscountBuilder = createWeekDayDiscountBuilder(visitDate);

        SoftAssertions softAssertions = new SoftAssertions();
        softAssertions.assertThat(weekDayDiscountBuilder.isAvailableDate()).isTrue();
        softAssertions.assertThat(weekDayDiscountBuilder.discount()).isEqualTo(DISCOUNT_AMOUNT_PER_MENU * 2);
    ...
    void checkNonDiscountableVisitDateTest(int date) {
        ...
        SoftAssertions softAssertions = new SoftAssertions();
        softAssertions.assertThat(weekDayDiscountBuilder.isAvailableDate()).isFalse();
        softAssertions.assertThat(weekDayDiscountBuilder.discount()).isEqualTo(NO_DISCOUNT);
